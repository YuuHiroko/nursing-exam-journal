window.QUESTIONS_DATA_NRS_UNIT2 = [
...
<div class="answer-section animate-slide-up">
  ...
  <div class="definition-box animate-scale-in">
    <strong>Aim:</strong> A broad, general statement of what the study intends to achieve overall. It is the "destination" of the research journey.<br><br>
    <strong>Objective:</strong> A specific, measurable, and achievable sub-goal that, when accomplished, fulfils the aim. Objectives answer <em>exactly</em> what will be done, who will be studied, and what will be measured.
  </div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Importance of Writing Aim and Objectives</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>#</th><th>Importance</th><th>Simple Meaning</th><th>Nursing Example</th></tr></thead>
    <tbody>
      <tr><td>1</td><td><strong>Provides Direction</strong></td><td>Tells researcher exactly where to go &mdash; prevents scope creep and wasted effort</td><td>"To assess pain levels in post-op patients" keeps nurse focused only on pain, not unrelated variables</td></tr>
      <tr><td>2</td><td><strong>Guides Methodology</strong></td><td>The objective determines the research design, tools, and data collection method</td><td>Objective "To compare anxiety scores" &rarr; requires comparative (experimental) design</td></tr>
      <tr><td>3</td><td><strong>Forms Basis for Hypothesis</strong></td><td>Every hypothesis is derived directly from the objectives</td><td>Objective: "To determine effect of music on anxiety" &rarr; H1: Music therapy significantly reduces pre-op anxiety</td></tr>
      <tr><td>4</td><td><strong>Guides Sample Selection</strong></td><td>Objectives define who the participants must be</td><td>"To assess in post-op adult patients" &rarr; inclusion criteria: adults, post-operative, one specific ward</td></tr>
      <tr><td>5</td><td><strong>Determines Data Collection Tools</strong></td><td>What you measure (objective) dictates which scale or instrument to use</td><td>"To assess anxiety" &rarr; use Hamilton Anxiety Rating Scale (HAM-A)</td></tr>
      <tr><td>6</td><td><strong>Enables Evaluation of Success</strong></td><td>At the end, did you achieve what you set out to do? Objectives make this measurable</td><td>If objective was "To assess pain" and pain was measured &rarr; objective achieved</td></tr>
      <tr><td>7</td><td><strong>Guides Data Analysis</strong></td><td>The statistical test used is chosen based on the objective</td><td>"To compare" (2 groups) &rarr; independent t-test or chi-square</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">SMART Criteria for Writing Objectives</h3>
  <ol class="answer-points">
    <li><strong>S &mdash; Specific:</strong> States exactly what will be studied (variable, population, setting)</li>
    <li><strong>M &mdash; Measurable:</strong> Can be quantified or observed (pain score, blood pressure, test score)</li>
    <li><strong>A &mdash; Achievable:</strong> Realistic given available time, resources, and access</li>
    <li><strong>R &mdash; Relevant:</strong> Directly linked to the research problem; not off-topic</li>
    <li><strong>T &mdash; Time-bound:</strong> Specifies when and for how long the study will run</li>
  </ol>
  <p class="answer-text"><strong>Good objective example:</strong> "To assess the level of pre-operative anxiety among adult patients (18&ndash;60 years) admitted in the surgical ward of Government Medical College, Nagpur, during January&ndash;March 2024, using the Hamilton Anxiety Rating Scale."<br>
  <strong>Bad objective (vague):</strong> "To study anxiety." &mdash; Too broad; not SMART.</p>
</div>

<div class="analogy-box"><strong>Think of it like&hellip;</strong> planning a road trip. The <strong>Aim</strong> is the destination city ("I want to reach Mumbai"). The <strong>Objectives</strong> are the specific waypoints: "Take NH-48, stop at Pune for fuel, arrive by 6 PM." Without objectives, you might start driving without knowing which route to take, stop at the wrong places, or arrive at the wrong city entirely.</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Mnemonic &mdash; <strong>"SMART"</strong> for Objectives</div>
  <div class="mnemonic-word"><span>S</span>-<span>M</span>-<span>A</span>-<span>R</span>-<span>T</span></div>
  <div class="mnemonic-explain"><strong>S</strong> = Specific &bull; <strong>M</strong> = Measurable &bull; <strong>A</strong> = Achievable &bull; <strong>R</strong> = Relevant &bull; <strong>T</strong> = Time-bound</div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">Aim</span><span class="kw">Objective</span><span class="kw">SMART</span><span class="kw">Direction</span><span class="kw">Measurable</span><span class="kw">Hypothesis</span><span class="kw">Research design</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>Aim = broad goal (destination) | Objectives = specific measurable steps (waypoints)</li>
    <li>Objectives must be SMART: Specific, Measurable, Achievable, Relevant, Time-bound</li>
    <li>Objectives guide: design, sample selection, data tools, statistical tests, and evaluation</li>
    <li>Every hypothesis is derived from an objective &mdash; no objective = no valid hypothesis</li>
    <li>Objectives begin with an action infinitive: "To assess...", "To compare...", "To evaluate..."</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">SMART</span> Specific, Measurable, Achievable, Relevant, Time-bound &mdash; criteria for writing good research objectives</li>
  <li><span class="term">HAM-A</span> Hamilton Anxiety Rating Scale &mdash; validated tool measuring anxiety severity in 14 items</li>
  <li><span class="term">Scope creep</span> &mdash; when a study starts studying too many things, losing focus and quality</li>
</ul></div>

<div class="self-test"><div class="self-test-title">Test Yourself</div>
<details><summary>What is the difference between Aim and Objective?</summary><p>Aim = broad, general statement of the overall goal of the study. Objective = specific, measurable, SMART step that breaks the aim into achievable targets. The aim is the destination; objectives are the route.</p></details>
...
<div class="in-short"><strong>In Short:</strong> A research problem has 5 key elements: <strong>Population</strong> (who), <strong>Variable(s)</strong> (what is being studied), <strong>Setting</strong> (where), <strong>Time frame</strong> (when), and a clear <strong>Problem Statement</strong> (why it matters and what gap exists). Together these elements make the problem specific, focused, and researchable.</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">What is a Research Problem?</h3>
  <div class="definition-box animate-scale-in">
    A <strong>research problem</strong> is a specific, clear statement of a gap in knowledge or an unexplained situation in nursing practice that requires systematic investigation. It answers: <em>"What specific issue will this study address, and why does it need to be studied?"</em>
  </div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">5 Key Elements of a Research Problem</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>#</th><th>Element</th><th>What it Identifies</th><th>Example</th></tr></thead>
    <tbody>
      <tr><td>1</td><td><strong>Population (Who)</strong></td><td>The specific group of people or subjects to be studied &mdash; defined with inclusion/exclusion criteria</td><td>"Post-operative adult patients aged 18&ndash;60 in surgical wards of government hospitals, Nagpur"</td></tr>
      <tr><td>2</td><td><strong>Variable(s) (What)</strong></td><td>The specific characteristic, quality, or condition being measured or studied<br>IV = what researcher manipulates; DV = what is measured as outcome</td><td>IV: Music therapy | DV: Pre-operative anxiety score (HAM-A)</td></tr>
      <tr><td>3</td><td><strong>Setting (Where)</strong></td><td>The specific place or context in which the study is conducted</td><td>Surgical ward, Government Medical College &amp; Hospital, Nagpur</td></tr>
      <tr><td>4</td><td><strong>Time Frame (When)</strong></td><td>The period during which data will be collected; defines the temporal boundary of the study</td><td>January to March 2024 (3-month data collection period)</td></tr>
      <tr><td>5</td><td><strong>Problem Statement / Knowledge Gap (Why)</strong></td><td>Explains what is unknown or what conflict/gap in knowledge exists &mdash; justifies the need for the study</td><td>"Despite anxiety affecting 70% of pre-op patients, few evidence-based non-pharmacological interventions are routinely used in Indian surgical wards."</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Detailed Explanation of Elements</h3>
  <ol class="answer-points">
    <li><strong>Population:</strong>
      <ul class="sub-points">
        <li>Must be clearly defined with inclusion criteria (who is IN) and exclusion criteria (who is OUT)</li>
        <li>Population vs Sample: Population = everyone with the characteristics; Sample = subset actually studied</li>
        <li>Example: Population = all adult surgical patients in India; Sample = 60 patients in one ward</li>
      </ul>
    </li>
    ...
    <li><strong>Knowledge Gap:</strong>
      <ul class="sub-points">
        <li>The most important element &mdash; justifies WHY the study is needed</li>
        <li>Found through review of literature (ROL): what do existing studies say? What do they NOT say?</li>
        <li>Example gap: "Studies on music therapy for anxiety exist in Western settings but not in Indian surgical wards."</li>
      </ul>
    </li>
  </ol>
</div>

<div class="editorial-example"><strong>Complete Research Problem Example:</strong><br>
"An assessment of the effect of music therapy (IV) on pre-operative anxiety scores (DV) among adult patients aged 18&ndash;60 (Population) in the surgical ward of Government Medical College, Nagpur (Setting), during January&ndash;June 2024 (Time frame)."<br>
<strong>Gap:</strong> "Evidence-based non-pharmacological anxiety interventions are rarely used in Indian government hospital surgical wards, leading to high pre-operative anxiety and poor surgical outcomes."</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Mnemonic &mdash; <strong>"PVSTG"</strong> (elements of research problem)</div>
  <div class="mnemonic-word"><span>P</span>-<span>V</span>-<span>S</span>-<span>T</span>-<span>G</span></div>
  <div class="mnemonic-explain"><strong>P</strong> = Population &bull; <strong>V</strong> = Variable(s) &bull; <strong>S</strong> = Setting &bull; <strong>T</strong> = Time frame &bull; <strong>G</strong> = Gap (knowledge gap / problem statement)</div>
</div>
...
<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>5 elements: PVSTG &mdash; Population, Variable(s), Setting, Time frame, Gap (knowledge gap)</li>
    <li>IV = what researcher manipulates (cause) | DV = what researcher measures (effect)</li>
    <li>Knowledge gap is the MOST important element &mdash; it justifies why the study is needed</li>
    <li>Population = everyone with the criteria | Sample = the subset actually studied</li>
  </ul>
</div>
...
<div class="in-short"><strong>In Short:</strong> An <strong>assumption</strong> is a condition or fact that the researcher <strong>accepts as true without actually testing or proving it</strong>. Every study rests on assumptions. They are stated clearly in the thesis but are NOT tested &mdash; unlike hypotheses.</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Definition of Assumption</h3>
  <div class="definition-box animate-scale-in">
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Types of Assumptions</h3>
  <div class="answer-table-wrap"><table class="answer-table">
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Examples of Assumptions in Nursing Research</h3>
  <ol class="answer-points">
    <li>Participants will respond to the questionnaire honestly and to the best of their ability</li>
    <li>The data collection instrument (validated scale) accurately measures the intended variable</li>
    <li>The sample selected is representative of the larger population</li>
    <li>Participants have the ability to understand and complete the questionnaire in the given language</li>
    <li>The setting (ward, hospital) is typical and representative of similar Indian hospitals</li>
    <li>Nursing interventions delivered during the study are carried out consistently as per the protocol</li>
  </ol>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title accent-title">Assumption vs Hypothesis &mdash; Key Difference</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Feature</th><th>Assumption</th><th>Hypothesis</th></tr></thead>
    <tbody>
      <tr><td>Definition</td><td>Accepted as true without testing</td><td>A testable prediction about a relationship</td></tr>
      <tr><td>Tested?</td><td>NO &mdash; taken for granted</td><td>YES &mdash; formally tested with data</td></tr>
      <tr><td>Stated where?</td><td>Chapter 1 (Assumptions section of thesis)</td><td>Chapter 1 (Hypotheses section) and tested in Chapter 4</td></tr>
      <tr><td>Example</td><td>"Participants will answer honestly."</td><td>"Music therapy significantly reduces pre-op anxiety."</td></tr>
    </tbody>
  </table></div>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong><br>
<strong>Assumption</strong> = taken for granted, NOT tested. Part of the study's foundation.<br>
<strong>Hypothesis</strong> = a prediction that IS formally tested using collected data and statistics.
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">Assumption</span><span class="kw">Taken for granted</span><span class="kw">Not tested</span><span class="kw">Substantive</span><span class="kw">Methodological</span><span class="kw">Chapter 1</span><span class="kw">Kerlinger</span>
</div>
...
<div class="self-test"><div class="self-test-title">Test Yourself</div>
<details><summary>Define assumption in one sentence.</summary><p>An assumption is a basic condition or principle that is accepted as true without proof in a research study &mdash; it is never formally tested.</p></details>
...
<div class="in-short"><strong>In Short:</strong> A good research problem must meet the <strong>FINER</strong> criteria: Feasible, Interesting, Novel, Ethical, Relevant. Additional criteria: must be Specific, Significant, and Researchable. A problem that fails any one criterion should be reconsidered or modified.</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Introduction</h3>
  <p class="answer-text">Selecting a research problem is the single most important step in research &mdash; it sets the direction for everything else. A poorly selected problem wastes time, money, and effort. Researchers use established criteria to evaluate whether a problem is worth studying before investing resources.</p>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Criteria for Selecting a Good Research Problem (FINER + SS)</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Criterion</th><th>Meaning</th><th>Test Question</th><th>If it Fails</th></tr></thead>
    <tbody>
      <tr><td><strong>F &mdash; Feasible</strong></td><td>The study can realistically be done with available time, budget, sample, skills, and equipment</td><td>"Can I collect enough patients, use this tool, and finish in 3 months with my budget?"</td><td>Study will not be completed; data will be incomplete or invalid</td></tr>
      <tr><td><strong>I &mdash; Interesting</strong></td><td>The researcher is genuinely motivated by the problem; passion drives quality</td><td>"Am I genuinely curious about this? Will I stay motivated for 12&ndash;18 months?"</td><td>Researcher loses motivation; quality suffers</td></tr>
      <tr><td><strong>N &mdash; Novel</strong></td><td>Adds new knowledge, replicates to confirm, or extends previous findings; not already thoroughly answered</td><td>"Has this exact question been answered in an Indian hospital context? What new angle does my study add?"</td><td>Study adds no value to existing knowledge</td></tr>
      <tr><td><strong>E &mdash; Ethical</strong></td><td>No harm to participants; respects dignity; IEC clearance obtainable; informed consent possible</td><td>"Will this study hurt anyone? Can I get ethics approval? Can patients freely refuse?"</td><td>Study cannot be conducted legally or morally; IEC will reject</td></tr>
      <tr><td><strong>R &mdash; Relevant</strong></td><td>Significant to nursing practice, education, or administration; findings will improve patient care or nursing knowledge</td><td>"Will this study matter to nurses, patients, or hospital management in India?"</td><td>Findings have no practical application; nobody benefits</td></tr>
      <tr><td><strong>S &mdash; Significant</strong></td><td>The problem is important enough to deserve research attention; it affects a meaningful number of people</td><td>"How many patients are affected? Will solving this make a real difference?"</td><td>Study results will be ignored; low impact</td></tr>
      <tr><td><strong>S &mdash; Specific</strong></td><td>The problem is stated clearly and narrowly enough to be investigated in one study</td><td>"Is this problem narrow enough to study with one sample, one tool, one setting?"</td><td>Study becomes too broad; unfocused; superficial results</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Additional Considerations in Selecting a Problem</h3>
  <ol class="answer-points">
    <li><strong>Researcher's expertise:</strong> Choose a problem within your area of nursing knowledge and clinical experience</li>
    <li><strong>Availability of data:</strong> Can the required data be collected? Are the participants accessible?</li>
    <li><strong>Literature support:</strong> Does existing literature provide enough theoretical/conceptual background?</li>
    <li><strong>Resources:</strong> Budget, time, instruments (scales, equipment), lab support if needed</li>
    <li><strong>Institutional support:</strong> Does the hospital/college support this type of research?</li>
  </ol>
</div>

<div class="editorial-example"><strong>Indian Nursing Example:</strong> A nurse wants to study "the effect of kangaroo mother care on neonatal mortality in all Indian hospitals." This fails FEASIBILITY (too large a study) and SPECIFICITY (too broad). After revision: "Effect of KMC on weight gain and temperature in low-birth-weight neonates in NICU of Government Medical College, Nagpur, January&ndash;June 2024." This passes ALL FINER+SS criteria and is a good research problem.</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Mnemonic &mdash; <strong>"FINER SS"</strong></div>
  <div class="mnemonic-word"><span>F</span>-<span>I</span>-<span>N</span>-<span>E</span>-<span>R</span>-<span>S</span>-<span>S</span></div>
  <div class="mnemonic-explain"><strong>F</strong> = Feasible &bull; <strong>I</strong> = Interesting &bull; <strong>N</strong> = Novel &bull; <strong>E</strong> = Ethical &bull; <strong>R</strong> = Relevant &bull; <strong>S</strong> = Significant &bull; <strong>S</strong> = Specific</div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">FINER</span><span class="kw">Feasible</span><span class="kw">Novel</span><span class="kw">Ethical</span><span class="kw">Relevant</span><span class="kw">Significant</span><span class="kw">Specific</span><span class="kw">IEC</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>Criteria: FINER SS &mdash; Feasible, Interesting, Novel, Ethical, Relevant, Significant, Specific</li>
    <li>Feasibility = most practical criterion (can you actually do it?)</li>
    <li>Ethical = IEC must approve; no harm; informed consent mandatory</li>
    <li>Novel = new knowledge OR confirms/extends existing knowledge</li>
    <li>If a problem fails even ONE criterion, reconsider or modify the problem</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">FINER</span> Feasible, Interesting, Novel, Ethical, Relevant &mdash; classic criteria for selecting a research problem</li>
  <li><span class="term">IEC</span> Institutional Ethics Committee &mdash; body that approves human research studies in India</li>
  <li><span class="term">KMC</span> Kangaroo Mother Care &mdash; skin-to-skin contact between mother and low-birth-weight neonate, proven to reduce mortality</li>
</ul></div>
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Classification of Hypothesis</h3>

  <h4>1. By Nature (Research vs Null)</h4>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Type</th><th>Symbol</th><th>What it States</th><th>Example</th></tr></thead>
    <tbody>
      <tr><td><strong>Research Hypothesis (H1)</strong></td><td>H1 or Ha</td><td>Predicts that a significant relationship or difference EXISTS between variables</td><td>"Music therapy significantly reduces pre-operative anxiety in adult surgical patients."</td></tr>
      <tr><td><strong>Null Hypothesis (H0)</strong></td><td>H0</td><td>Predicts NO significant relationship or difference between variables. It is the one actually tested statistically</td><td>"There is no significant difference in pre-operative anxiety between music therapy and control groups."</td></tr>
    </tbody>
  </table></div>

  <h4>2. By Direction</h4>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Type</th><th>What it States</th><th>Used When</th><th>Example</th></tr></thead>
    <tbody>
      <tr><td><strong>Directional (One-tailed)</strong></td><td>Predicts the DIRECTION of the relationship (higher, lower, more, less, positive, negative)</td><td>When prior research or theory clearly supports a specific direction</td><td>"Music therapy will <em>significantly decrease</em> pre-op anxiety scores compared to control."</td></tr>
      <tr><td><strong>Non-directional (Two-tailed)</strong></td><td>Predicts that a difference EXISTS but does NOT predict the direction</td><td>When there is insufficient prior evidence to predict direction</td><td>"There will be a significant difference in anxiety scores between music therapy and control groups."</td></tr>
    </tbody>
  </table></div>

  <h4>3. By Complexity</h4>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Type</th><th>Variables involved</th><th>Example</th></tr></thead>
    <tbody>
      <tr><td><strong>Simple Hypothesis</strong></td><td>ONE independent variable &rarr; ONE dependent variable</td><td>"Music therapy (IV) reduces pre-op anxiety (DV) in adult surgical patients."</td></tr>
      <tr><td><strong>Complex Hypothesis</strong></td><td>TWO or more IVs and/or TWO or more DVs</td><td>"Music therapy and progressive muscle relaxation (2 IVs) reduce both anxiety scores and heart rate (2 DVs) in pre-op patients."</td></tr>
    </tbody>
  </table></div>

  <h4>4. By Research Approach</h4>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Type</th><th>What it States</th><th>Example</th></tr></thead>
    <tbody>
      <tr><td><strong>Associative Hypothesis</strong></td><td>Predicts a relationship (correlation) between variables, without implying cause &amp; effect</td><td>"There is a significant positive correlation between nurses' burnout levels and medication error rates."</td></tr>
      <tr><td><strong>Causal Hypothesis</strong></td><td>Predicts that IV causes a change in DV (cause-and-effect); used in experimental studies</td><td>"2-hourly repositioning (IV) significantly reduces pressure ulcer incidence (DV) in bedridden ICU patients."</td></tr>
    </tbody>
  </table></div>
</div>

<div class="flowchart">
  <div class="flowchart-title">Classification of Hypothesis</div>
  <div class="flowchart-container">
    <div class="flow-box highlight">HYPOTHESIS</div>
    <div class="flow-arrow">&darr;</div>
    <div class="flow-branch">
      <div class="flow-branch-item"><div class="flow-branch-line"></div><div class="flow-box">By Nature<br>H1 (Research) vs H0 (Null)</div></div>
      <div class="flow-branch-item"><div class="flow-branch-line"></div><div class="flow-box">By Direction<br>Directional vs Non-directional</div></div>
      <div class="flow-branch-item"><div class="flow-branch-line"></div><div class="flow-box">By Complexity<br>Simple vs Complex</div></div>
      <div class="flow-branch-item"><div class="flow-branch-line"></div><div class="flow-box">By Approach<br>Associative vs Causal</div></div>
    </div>
  </div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">H1</span><span class="kw">H0</span><span class="kw">Directional</span><span class="kw">Non-directional</span><span class="kw">Simple</span><span class="kw">Complex</span><span class="kw">Associative</span><span class="kw">Causal</span><span class="kw">One-tailed</span><span class="kw">Two-tailed</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>By Nature: H1 (predicts effect EXISTS) vs H0 (predicts NO effect) &mdash; H0 is the one statistically tested</li>
    <li>By Direction: Directional (predicts higher/lower) vs Non-directional (predicts just "different")</li>
    <li>By Complexity: Simple (1 IV &rarr; 1 DV) vs Complex (2+ IVs or 2+ DVs)</li>
    <li>By Approach: Associative (correlation, no cause) vs Causal (IV causes DV, experimental)</li>
    <li>p &lt; 0.05 = reject H0, accept H1 = statistically significant result</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">H1</span> Research/Alternative Hypothesis &mdash; predicts that a significant relationship or difference exists</li>
  <li><span class="term">H0</span> Null Hypothesis &mdash; predicts no significant relationship; this is the one statistically tested</li>
  <li><span class="term">One-tailed test</span> &mdash; statistical test used when hypothesis is directional (tests only one direction)</li>
  <li><span class="term">Two-tailed test</span> &mdash; statistical test used when hypothesis is non-directional (tests both directions)</li>
</ul></div>
...
<div class="in-short"><strong>In Short:</strong> A good research problem statement must be <strong>C-S-R-F-E-S-N</strong>: Clear, Specific, Researchable, Feasible, Ethical, Significant, and Novel. It should be written as a question or declarative statement that precisely identifies the population, variable, and setting.</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">What is a Research Problem Statement?</h3>
  <div class="definition-box animate-scale-in">
    A <strong>research problem statement</strong> is a precise, written declaration of the specific gap in knowledge or unexplained clinical situation that the research study will address. It tells the reader WHAT will be studied, WHO will be studied, WHERE, and WHY the study is needed.
  </div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Characteristics of a Good Research Problem Statement</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>#</th><th>Characteristic</th><th>Simple Meaning</th><th>Example / Violation</th></tr></thead>
    <tbody>
      <tr><td>1</td><td><strong>Clear and Unambiguous</strong></td><td>Written in plain language; no vague or confusing terms; reader understands exactly what is being studied</td><td>Clear: "Effect of music therapy on HAM-A anxiety score." Vague: "Study of anxiety."</td></tr>
      <tr><td>2</td><td><strong>Specific and Focused</strong></td><td>Narrow enough to be studied in one research project; identifies the specific population, variable, and setting</td><td>Good: "Post-op adults, surgical ward, Government Hospital Nagpur." Bad: "All patients everywhere."</td></tr>
      <tr><td>3</td><td><strong>Researchable</strong></td><td>The problem can be answered by collecting and analyzing actual data &mdash; not a philosophical or moral question</td><td>Researchable: "Does hand hygiene reduce CAUTI?" Not researchable: "Is nursing a noble profession?"</td></tr>
      <tr><td>4</td><td><strong>Feasible</strong></td><td>Can be studied within realistic time, budget, access to participants, and researcher's expertise</td><td>Feasible: 60 patients, 3 months, one hospital. Not feasible: "All ICU patients in India, 1 week."</td></tr>
      <tr><td>5</td><td><strong>Ethical</strong></td><td>Does not cause harm, respects participants' rights, and IEC approval can be obtained</td><td>Ethical: music therapy for anxiety. Unethical: withholding pain medication to study pain scores.</td></tr>
      <tr><td>6</td><td><strong>Significant</strong></td><td>The findings will make a meaningful contribution to nursing knowledge or patient care</td><td>Significant: "Reducing hospital-acquired infections affects every admitted patient in India."</td></tr>
      <tr><td>7</td><td><strong>Novel</strong></td><td>Adds new knowledge, confirms important findings, or applies existing evidence in a new context</td><td>Novel: applying Western evidence on KMC to Indian NICU settings for the first time.</td></tr>
      <tr><td>8</td><td><strong>States the Variables Clearly</strong></td><td>Clearly identifies the independent variable (IV), dependent variable (DV), and population</td><td>"Effect of (IV: music therapy) on (DV: anxiety score) among (Population: pre-op adults)."</td></tr>
    </tbody>
  </table></div>
</div>

<div class="editorial-example"><strong>Well-Written Problem Statement:</strong> "A study to assess the effect of structured music therapy (IV) on pre-operative anxiety scores (DV) as measured by the Hamilton Anxiety Rating Scale, among adult patients (18&ndash;60 years) admitted for elective surgery in the surgical ward of Government Medical College &amp; Hospital, Nagpur, during January&ndash;June 2024."<br><br>
<strong>Why it's good:</strong> Clear (specific tool named), Specific (one ward, one hospital, age range), Researchable (data can be collected), Feasible (one hospital, 6 months), Ethical (music therapy is harmless), Significant (anxiety affects all surgical patients), Novel (Indian government hospital context).</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Mnemonic &mdash; <strong>"CSR FESN"</strong></div>
  <div class="mnemonic-word"><span>C</span>-<span>S</span>-<span>R</span>-<span>F</span>-<span>E</span>-<span>S</span>-<span>N</span></div>
  <div class="mnemonic-explain"><strong>C</strong> = Clear &bull; <strong>S</strong> = Specific &bull; <strong>R</strong> = Researchable &bull; <strong>F</strong> = Feasible &bull; <strong>E</strong> = Ethical &bull; <strong>S</strong> = Significant &bull; <strong>N</strong> = Novel</div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">CSR FESN</span><span class="kw">Clear</span><span class="kw">Specific</span><span class="kw">Researchable</span><span class="kw">Feasible</span><span class="kw">Ethical</span><span class="kw">Significant</span><span class="kw">Novel</span><span class="kw">IV</span><span class="kw">DV</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>8 characteristics: CSR FESN (Clear, Specific, Researchable, Feasible, Ethical, Significant, Novel)</li>
    <li>Must state: IV (what the researcher does/studies) + DV (what is measured) + Population + Setting</li>
    <li>"Study of anxiety" = BAD. "Effect of music therapy on HAM-A anxiety in post-op adults, Nagpur, 2024" = GOOD</li>
    <li>A research problem IS researchable only if data can actually be collected to answer it</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">HAM-A</span> Hamilton Anxiety Rating Scale &mdash; validated 14-item scale measuring anxiety severity</li>
  <li><span class="term">CAUTI</span> Catheter-Associated Urinary Tract Infection &mdash; UTI due to urinary catheter use</li>
  <li><span class="term">IEC</span> Institutional Ethics Committee &mdash; approves human research in India</li>
  <li><span class="term">KMC</span> Kangaroo Mother Care &mdash; skin-to-skin contact for premature/LBW neonates</li>
</ul></div>
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Definition</h3>
  <div class="definition-box animate-scale-in">
    A <strong>hypothesis</strong> is a <strong>tentative, testable prediction</strong> stated before data collection about the expected relationship between two or more variables. It guides the research design and is tested using statistics.<br><br>
    <strong>Polit &amp; Beck:</strong> "A hypothesis is a statement of expected relationships between variables."
  </div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Types of Hypothesis</h3>

  <h4>Type 1: Research (Alternate) Hypothesis &mdash; H1</h4>
  <ul class="answer-points">
    <li>Predicts that a significant relationship or difference EXISTS between variables</li>
    <li>Also called the "working hypothesis" or "alternate hypothesis"</li>
    <li><strong>Example:</strong> "Music therapy significantly reduces pre-operative anxiety in adult surgical patients (p &lt; 0.05)."</li>
  </ul>

  <h4>Type 2: Null Hypothesis &mdash; H0</h4>
  <ul class="answer-points">
    <li>Predicts NO significant relationship or difference between variables</li>
    <li>This is the hypothesis actually subjected to statistical testing</li>
    <li>If p &lt; 0.05 &rarr; H0 is REJECTED &rarr; H1 is supported (result is significant)</li>
    <li>If p &gt; 0.05 &rarr; H0 is ACCEPTED (retained) &rarr; no significant difference found</li>
    <li><strong>Example:</strong> "There is no significant difference in pre-operative anxiety between music therapy and control groups."</li>
  </ul>

  <h4>Type 3: Directional Hypothesis</h4>
  <ul class="answer-points">
    <li>Predicts both THAT a difference exists AND which DIRECTION (higher, lower, better, worse)</li>
    <li>Based on prior research or strong theoretical reasoning</li>
    <li>Tested with a one-tailed statistical test</li>
    <li><strong>Example:</strong> "Music therapy will <em>significantly decrease</em> (direction: decrease) anxiety scores compared to the control group."</li>
  </ul>

  <h4>Type 4: Non-directional Hypothesis</h4>
  <ul class="answer-points">
    <li>Predicts a significant difference or relationship exists but does NOT specify the direction</li>
    <li>Used when there is insufficient prior evidence to predict direction</li>
    <li>Tested with a two-tailed statistical test</li>
    <li><strong>Example:</strong> "There will be a significant difference in anxiety scores between music therapy and control groups."</li>
  </ul>

  <h4>Type 5: Simple Hypothesis</h4>
  <ul class="answer-points">
    <li>States the relationship between ONE independent variable and ONE dependent variable</li>
    <li><strong>Example:</strong> "2-hourly repositioning (1 IV) reduces pressure ulcer incidence (1 DV) in bedridden patients."</li>
  </ul>

  <h4>Type 6: Complex Hypothesis</h4>
  <ul class="answer-points">
    <li>States the relationship between TWO or more IVs and/or TWO or more DVs</li>
    <li><strong>Example:</strong> "Music therapy and aromatherapy (2 IVs) reduce both anxiety scores and systolic blood pressure (2 DVs) in pre-op patients."</li>
  </ul>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong><br>
<strong>H1 vs H0:</strong> H1 = "Something IS happening" (predicts effect). H0 = "Nothing is happening" (predicts no effect). Statistics test H0 &mdash; if p &lt; 0.05, we reject H0 and accept H1.<br>
<strong>Directional vs Non-directional:</strong> Directional says HOW (increase/decrease); Non-directional just says there WILL BE a difference.
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">H1</span><span class="kw">H0</span><span class="kw">Research hypothesis</span><span class="kw">Null hypothesis</span><span class="kw">Directional</span><span class="kw">Non-directional</span><span class="kw">Simple</span><span class="kw">Complex</span><span class="kw">p-value</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>H1 = predicts effect EXISTS | H0 = predicts NO effect &mdash; H0 is tested statistically</li>
    <li>Directional = specifies direction (increase/decrease) &rarr; one-tailed test</li>
    <li>Non-directional = predicts difference, no direction &rarr; two-tailed test</li>
    <li>Simple = 1 IV &rarr; 1 DV | Complex = 2+ IVs or 2+ DVs</li>
    <li>p &lt; 0.05 &rarr; reject H0, support H1 (statistically significant)</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">H1 / Ha</span> Research/Alternate Hypothesis &mdash; predicts significant relationship or difference exists</li>
  <li><span class="term">H0</span> Null Hypothesis &mdash; predicts no significant relationship; statistically tested</li>
  <li><span class="term">p-value</span> &mdash; probability the result occurred by chance; p &lt; 0.05 = statistically significant</li>
  <li><span class="term">One-tailed test</span> &mdash; used with directional hypothesis; tests in one direction only</li>
  <li><span class="term">Two-tailed test</span> &mdash; used with non-directional hypothesis; tests in both directions</li>
</ul></div>
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Types of Hypothesis</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Type</th><th>Symbol</th><th>What it Predicts</th><th>Nursing Example</th></tr></thead>
    <tbody>
      <tr><td><strong>Research Hypothesis</strong></td><td>H1 or Ha</td><td>A significant relationship or difference EXISTS</td><td>"2-hourly repositioning significantly reduces pressure ulcer incidence in ICU patients."</td></tr>
      <tr><td><strong>Null Hypothesis</strong></td><td>H0</td><td>NO significant relationship or difference exists; statistically tested</td><td>"There is no significant difference in pressure ulcer incidence between 2-hourly and 4-hourly repositioning groups."</td></tr>
      <tr><td><strong>Directional Hypothesis</strong></td><td>H1 (dir)</td><td>Difference exists AND specifies the direction (higher, lower, more, less)</td><td>"2-hourly repositioning will SIGNIFICANTLY DECREASE pressure ulcer incidence compared to 4-hourly." (direction: decrease)</td></tr>
      <tr><td><strong>Non-directional Hypothesis</strong></td><td>H1 (non-dir)</td><td>Difference exists but direction NOT specified</td><td>"There will be a significant difference in pressure ulcer incidence between 2-hourly and 4-hourly repositioning groups."</td></tr>
      <tr><td><strong>Simple Hypothesis</strong></td><td>&mdash;</td><td>ONE IV predicts ONE DV</td><td>"KMC (IV) increases neonatal weight gain (DV)."</td></tr>
      <tr><td><strong>Complex Hypothesis</strong></td><td>&mdash;</td><td>Multiple IVs and/or multiple DVs</td><td>"KMC and breast feeding support (2 IVs) improve weight gain and temperature stability (2 DVs) in LBW neonates."</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">How Hypothesis is Tested</h3>
  <ol class="answer-points">
    <li>Write H1 and H0 before data collection begins</li>
    <li>Collect data using valid, reliable instruments from a sufficient sample</li>
    <li>Apply appropriate statistical test (t-test, chi-square, ANOVA, Pearson's r)</li>
    <li>Calculate p-value: if p &lt; 0.05 &rarr; reject H0, support H1 (statistically significant result)</li>
    <li>Report and discuss findings; link back to original hypothesis</li>
  </ol>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong><br>
<strong>Hypothesis</strong> = tested with data (formal statistical testing).<br>
<strong>Assumption</strong> = accepted as true without testing (taken for granted).<br>
<strong>Objective</strong> = what the researcher aims to DO; hypothesis = what the researcher PREDICTS will be found.
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">H1</span><span class="kw">H0</span><span class="kw">Directional</span><span class="kw">Non-directional</span><span class="kw">Simple</span><span class="kw">Complex</span><span class="kw">p &lt; 0.05</span><span class="kw">Testable</span><span class="kw">Declarative</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>Hypothesis = tentative, testable, declarative statement about variable relationship</li>
    <li>H1 = predicts effect EXISTS | H0 = predicts NO effect (H0 is tested statistically)</li>
    <li>Directional = states direction (increase/decrease) &rarr; one-tailed test</li>
    <li>Non-directional = states difference but not direction &rarr; two-tailed test</li>
    <li>p &lt; 0.05 = reject H0, accept H1 = statistically significant</li>
  </ul>
</div>
...
<ul>
  ...
  <li><span class="term">H0</span> Null Hypothesis &mdash; predicts no effect; statistically tested using p-value</li>
  <li><span class="term">KMC</span> Kangaroo Mother Care &mdash; skin-to-skin neonatal care reducing hypothermia and mortality</li>
  <li><span class="term">LBW</span> Low Birth Weight &mdash; birth weight less than 2.5 kg</li>
...
<div class="in-short"><strong>In Short:</strong> Criteria for writing objectives: must be <strong>SMART</strong> (Specific, Measurable, Achievable, Relevant, Time-bound), <strong>begin with a verb</strong> ("To assess/compare/evaluate"), <strong>state one aim per objective</strong>, and be <strong>clearly linked to the research problem</strong>. Each objective should be testable and lead directly to a hypothesis.</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Introduction</h3>
  <p class="answer-text">Research objectives are the specific, measurable aims that break the broad research aim into manageable, testable components. Well-written objectives determine the research design, data collection tools, and statistical tests. Poorly written objectives make the study unfocused and difficult to evaluate.</p>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Criteria for Writing Research Objectives</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>#</th><th>Criterion</th><th>What it Means</th><th>Example</th></tr></thead>
    <tbody>
      <tr><td>1</td><td><strong>Specific</strong></td><td>States EXACTLY what will be studied &mdash; names the variable, population, and setting clearly; no vague terms</td><td>"To assess the level of pre-operative anxiety" (specific variable: anxiety; specific group: pre-op patients)</td></tr>
      <tr><td>2</td><td><strong>Measurable</strong></td><td>The outcome can be quantified or observed using a validated tool or criterion; results must be assessable</td><td>"Anxiety measured using HAM-A scale (0&ndash;56)" gives a quantifiable, measurable outcome</td></tr>
      <tr><td>3</td><td><strong>Achievable</strong></td><td>Realistic and attainable within the available resources (budget, time, participant access, researcher's skill)</td><td>60 patients, one ward, 3 months &mdash; achievable for a nursing student researcher</td></tr>
      <tr><td>4</td><td><strong>Relevant</strong></td><td>Directly related to the research problem; not tangential or off-topic</td><td>Objective on anxiety is relevant in a study about pre-op preparation; not relevant in a wound healing study</td></tr>
      <tr><td>5</td><td><strong>Time-bound</strong></td><td>Specifies the time period for data collection; gives the study a defined boundary</td><td>"During January&ndash;June 2024" &mdash; this is the time-bound component</td></tr>
      <tr><td>6</td><td><strong>Begins with an Action Verb (Infinitive)</strong></td><td>Uses "To assess...", "To compare...", "To evaluate...", "To determine...", "To identify..." &mdash; active, directional language</td><td>"To assess the level of..." NOT "Studying the level of..." (wrong form)</td></tr>
      <tr><td>7</td><td><strong>One Idea per Objective</strong></td><td>Each objective addresses only ONE variable or ONE relationship; complex multi-part objectives are split</td><td>WRONG: "To assess anxiety AND measure blood pressure AND determine satisfaction." Split into 3 separate objectives.</td></tr>
      <tr><td>8</td><td><strong>Linked to Hypothesis</strong></td><td>Each objective leads directly to a testable hypothesis &mdash; the objective says WHAT; the hypothesis predicts the OUTCOME</td><td>Objective: "To compare anxiety..." &rarr; H1: "Music therapy significantly reduces anxiety scores."</td></tr>
      <tr><td>9</td><td><strong>Ethical</strong></td><td>The objective can be pursued without causing harm, violating privacy, or raising ethical concerns</td><td>Objective involving invasive procedures requires extra ethics consideration and IEC approval</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Approved Action Verbs for Objectives</h3>
  <ol class="answer-points">
    <li><strong>"To assess"</strong> &mdash; used when measuring a level, score, or status (cross-sectional/descriptive)</li>
    <li><strong>"To compare"</strong> &mdash; used when comparing two or more groups (experimental/quasi-experimental)</li>
    <li><strong>"To evaluate"</strong> &mdash; used when judging effectiveness of an intervention</li>
    <li><strong>"To determine"</strong> &mdash; used when finding an association or correlation</li>
    <li><strong>"To identify"</strong> &mdash; used in qualitative or exploratory studies</li>
    <li><strong>"To explore"</strong> &mdash; used in qualitative studies (themes, experiences)</li>
  </ol>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong><br>
<strong>Aim</strong> = broad, overall goal ("To study the effect of music therapy on pre-op anxiety")<br>
<strong>Objective</strong> = specific, measurable target ("To compare HAM-A anxiety scores between music therapy group and control group among adult patients in Nagpur, January&ndash;June 2024")<br>
<strong>Hypothesis</strong> = prediction about the outcome ("Music therapy will significantly reduce anxiety scores")
</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Mnemonic &mdash; <strong>"SMART + ALE"</strong></div>
  <div class="mnemonic-word"><span>S</span>-<span>M</span>-<span>A</span>-<span>R</span>-<span>T</span>-<span>A</span>-<span>L</span>-<span>E</span></div>
  <div class="mnemonic-explain"><strong>S</strong> = Specific &bull; <strong>M</strong> = Measurable &bull; <strong>A</strong> = Achievable &bull; <strong>R</strong> = Relevant &bull; <strong>T</strong> = Time-bound &bull; <strong>A</strong> = Action verb &bull; <strong>L</strong> = Linked to hypothesis &bull; <strong>E</strong> = Ethical</div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">SMART</span><span class="kw">Specific</span><span class="kw">Measurable</span><span class="kw">Achievable</span><span class="kw">Relevant</span><span class="kw">Time-bound</span><span class="kw">Action verb</span><span class="kw">To assess</span><span class="kw">To compare</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>Objectives must be SMART + begin with action verb + one idea per objective + linked to hypothesis</li>
    <li>Good verbs: To assess, To compare, To evaluate, To determine, To identify, To explore</li>
    <li>One objective = one variable or relationship. Never combine multiple ideas.</li>
    <li>Objective &rarr; determines design | Objective &rarr; determines tool | Objective &rarr; generates hypothesis</li>
    <li>Bad: "Studying anxiety." Good: "To assess the level of anxiety using HAM-A in pre-op patients, Nagpur, Jan&ndash;Jun 2024."</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">SMART</span> Specific, Measurable, Achievable, Relevant, Time-bound &mdash; international standard criteria for objectives</li>
  <li><span class="term">HAM-A</span> Hamilton Anxiety Rating Scale &mdash; validated 14-item scale (score 0&ndash;56; &ge;14 = mild anxiety)</li>
  <li><span class="term">Infinitive form</span> &mdash; "to + verb" form used to start research objectives (e.g., "To assess...")</li>
</ul></div>
...
<div class="in-short"><strong>In Short:</strong> A good research objective must be <strong>SMART</strong> — Specific, Measurable, Achievable, Relevant, Time-bound — plus it must be written in <strong>declarative form starting with "To"</strong>, state only <strong>one idea</strong>, use a clear <strong>action verb</strong>, and be directly <strong>linked to the research problem</strong>.</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Characteristics of a Research Objective</h3>
  <ol class="answer-points">
    <li><strong>Specific:</strong> Names the exact variable, population, and setting. No vague terms like "study anxiety" — instead: "assess HAM-A anxiety scores in pre-op adult patients, Nagpur."</li>
    <li><strong>Measurable:</strong> The outcome can be quantified with a validated instrument or observation. Example: "Anxiety score measured using HAM-A (0–56)" is measurable.</li>
    <li><strong>Achievable:</strong> Realistic given available time, budget, sample size, and researcher's expertise. An objective requiring 10,000 patients in 1 week is NOT achievable for a nursing student.</li>
    <li><strong>Relevant:</strong> Directly linked to the research problem. An objective about blood pressure is not relevant in a study on anxiety.</li>
    <li><strong>Time-bound:</strong> States the data collection period (e.g., "during January–June 2024").</li>
    <li><strong>Begins with an action verb (infinitive form):</strong> "To assess...", "To compare...", "To evaluate...", "To determine...", "To identify..."</li>
    <li><strong>One idea per objective:</strong> Each objective addresses only ONE variable or relationship. Never combine multiple variables in one objective.</li>
    <li><strong>Written in declarative form:</strong> A statement (not a question). "To assess..." NOT "What is the level of...?"</li>
    <li><strong>Linked to a hypothesis:</strong> Each objective directly generates a testable hypothesis. Objective: "To compare anxiety..." → H1: "Music therapy significantly reduces anxiety."</li>
    <li><strong>Ethical:</strong> Can be pursued without causing harm or violating participants' rights.</li>
  </ol>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">SMART</span><span class="kw">Specific</span><span class="kw">Measurable</span><span class="kw">Achievable</span><span class="kw">Relevant</span><span class="kw">Time-bound</span><span class="kw">Action verb</span><span class="kw">Declarative</span>
</div>
...
<div class="remember-box">
  ...
  <ul>
    ...
    <li>Starts with "To + action verb" (To assess, To compare, To evaluate)</li>
    <li>One objective = one variable or one relationship only</li>
    <li>Declarative statement, NOT a question</li>
    <li>Each objective links directly to a testable hypothesis</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">SMART</span> Specific, Measurable, Achievable, Relevant, Time-bound &mdash; standard criteria for research objectives</li>
  <li><span class="term">Declarative form</span> &mdash; written as a statement ("To assess...") not as a question ("What is the level of...?")</li>
</ul></div>
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Types of Hypothesis with Nursing Examples</h3>

  <h4>1. Research Hypothesis (H1) — "Something IS happening"</h4>
  <ul class="answer-points">
    <li>Predicts that a significant effect, difference, or relationship EXISTS</li>
    <li><strong>Nursing Example 1:</strong> "2-hourly repositioning significantly reduces pressure ulcer incidence in bedridden ICU patients compared to 4-hourly repositioning."</li>
    <li><strong>Nursing Example 2:</strong> "There is a significant positive correlation between nurse-patient ratio and medication error rates in medical wards."</li>
  </ul>

  <h4>2. Null Hypothesis (H0) — "Nothing is happening"</h4>
  <ul class="answer-points">
    <li>Predicts NO significant difference or relationship; this is the one statistically tested</li>
    <li>If p &lt; 0.05 &rarr; reject H0 &rarr; H1 is supported (statistically significant)</li>
    <li><strong>Example:</strong> "There is no significant difference in pressure ulcer incidence between 2-hourly and 4-hourly repositioning groups."</li>
  </ul>

  <h4>3. Directional Hypothesis</h4>
  <ul class="answer-points">
    <li>Predicts both THAT a difference exists AND its DIRECTION (increase/decrease/higher/lower)</li>
    <li>Used when prior evidence clearly supports a specific direction; tested with one-tailed test</li>
    <li><strong>Example:</strong> "Kangaroo Mother Care will <em>significantly increase</em> neonatal weight gain in LBW babies compared to incubator care."</li>
  </ul>

  <h4>4. Non-directional Hypothesis</h4>
  <ul class="answer-points">
    <li>Predicts a significant difference or relationship but does NOT specify the direction</li>
    <li>Used when insufficient prior evidence; tested with two-tailed test</li>
    <li><strong>Example:</strong> "There will be a significant difference in neonatal weight gain between KMC group and incubator care group."</li>
  </ul>

  <h4>5. Simple Hypothesis</h4>
  <ul class="answer-points">
    <li>ONE independent variable predicts ONE dependent variable</li>
    <li><strong>Example:</strong> "Music therapy (1 IV) significantly reduces pre-operative anxiety scores (1 DV)."</li>
  </ul>

  <h4>6. Complex Hypothesis</h4>
  <ul class="answer-points">
    <li>TWO or more IVs and/or TWO or more DVs involved</li>
    <li><strong>Example:</strong> "Music therapy and deep breathing exercises (2 IVs) significantly reduce both anxiety scores and systolic blood pressure (2 DVs) in pre-operative patients."</li>
  </ul>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong><br>
<strong>H1 vs H0:</strong> H1 predicts effect EXISTS; H0 predicts NO effect. Statistics always test H0 — we either reject it (p &lt; 0.05) or retain it (p &gt; 0.05).<br>
<strong>Directional vs Non-directional:</strong> Directional says HOW (increase/decrease); Non-directional says there WILL BE a difference but doesn't say which way.
</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Quick Summary of Types</div>
  <div class="mnemonic-explain">
    H1 = Has effect &bull; H0 = Has NO effect (tested statistically)<br>
    Directional = Direction specified &bull; Non-directional = No direction<br>
    Simple = 1 IV &rarr; 1 DV &bull; Complex = Multiple IVs/DVs
  </div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">H1</span><span class="kw">H0</span><span class="kw">Directional</span><span class="kw">Non-directional</span><span class="kw">Simple</span><span class="kw">Complex</span><span class="kw">Testable</span><span class="kw">Declarative</span><span class="kw">p-value</span><span class="kw">Kerlinger</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>Hypothesis = tentative, declarative, testable prediction about variable relationships</li>
    <li>H1 = predicts effect EXISTS | H0 = predicts NO effect; H0 is statistically tested</li>
    <li>p &lt; 0.05 &rarr; reject H0, support H1 (significant result)</li>
    <li>Directional (one-tailed): specifies direction | Non-directional (two-tailed): no direction</li>
    <li>Simple: 1 IV &rarr; 1 DV | Complex: multiple IVs/DVs</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">H1</span> Research Hypothesis &mdash; predicts significant effect or relationship exists</li>
  <li><span class="term">H0</span> Null Hypothesis &mdash; predicts no significant effect; statistically tested</li>
  <li><span class="term">KMC</span> Kangaroo Mother Care &mdash; skin-to-skin contact for low-birth-weight neonates</li>
  <li><span class="term">LBW</span> Low Birth Weight &mdash; birth weight below 2.5 kg</li>
  <li><span class="term">p-value</span> &mdash; probability result is due to chance; p &lt; 0.05 = statistically significant</li>
</ul></div>
...
<div class="answer-section animate-slide-up">
  ...
  <div class="definition-box animate-scale-in">
    A <strong>variable</strong> is any <strong>characteristic, quality, or condition that can take different values</strong> among subjects, settings, or situations in a study. Variables are the building blocks of every research question and hypothesis.<br><br>
    <strong>Examples of variables:</strong> Pain score, blood pressure, age, gender, anxiety level, weight, nurse-patient ratio, hand hygiene compliance.
  </div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Types of Variables</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    ...
    <tbody>
      ...
      <tr><td>7</td><td><strong>Qualitative / Categorical Variable</strong></td><td>Describes categories or groups; no numerical value; data analyzed by frequency/percentage</td><td>Gender (male/female), blood group (A/B/AB/O), religion, type of surgery, ward type</td></tr>
      <tr><td>8</td><td><strong>Quantitative Variable</strong></td><td>Has a numerical value that can be measured and analyzed statistically</td><td>Weight, height, BP, pain score, temperature, Braden Scale score, HAM-A score</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">IV and DV in a Nursing Research Example</h3>
  <p class="answer-text"><strong>Study:</strong> "Effect of music therapy on pre-operative anxiety in adult surgical patients."</p>
  <ul class="answer-points">
...
<div class="in-short"><strong>In Short:</strong> Sources for identifying research problems include: <strong>clinical practice</strong> (bedside observations), <strong>literature review</strong> (reading research gaps), <strong>previous research recommendations</strong>, <strong>nursing theories</strong>, <strong>government health priorities</strong>, <strong>peer discussions</strong>, and <strong>personal experience</strong>. The best problems come from real, unresolved clinical gaps.</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Introduction</h3>
  <p class="answer-text">Identifying a good research problem is the first and most critical step in research. A problem that is not truly significant or not firmly grounded in a real gap in knowledge will lead to a study with limited value. Nurse researchers draw from several sources to identify relevant, significant, and researchable problems.</p>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Sources of Identifying Research Problem Statement</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>#</th><th>Source</th><th>How it Helps</th><th>Indian Nursing Example</th></tr></thead>
    <tbody>
      <tr><td>1</td><td><strong>Clinical Nursing Practice (Bedside Observations)</strong></td><td>Day-to-day patient care reveals unsolved problems that need evidence-based solutions</td><td>ICU nurse observes high pressure ulcer rates despite standard care &rarr; "Is 2-hourly repositioning better than 4-hourly?"</td></tr>
      <tr><td>2</td><td><strong>Review of Literature (Published Research)</strong></td><td>Reading existing studies reveals gaps, contradictions, and areas needing further investigation; the most systematic source</td><td>Reading journals (Indian Journal of Nursing) reveals no Indian study on music therapy for pre-op anxiety &rarr; research gap identified</td></tr>
      <tr><td>3</td><td><strong>Previous Research / Study Recommendations</strong></td><td>Research papers explicitly state "further studies are needed on..." or "this needs to be replicated in..." in their conclusion</td><td>A US study on KMC recommends "replication in low-income countries" &rarr; Indian nurse conducts Indian KMC study</td></tr>
      <tr><td>4</td><td><strong>Nursing Theories and Conceptual Models</strong></td><td>Nursing theories (e.g., Orem's Self-Care Theory, Pender's Health Promotion Model) suggest areas for testing in real populations</td><td>Orem's theory applied to diabetic self-care in Indian rural patients &rarr; study problem identified</td></tr>
      <tr><td>5</td><td><strong>Government Health Priorities and National Programmes</strong></td><td>National health schemes highlight gaps where nursing research is needed (e.g., NHM, RMNCH+A, NABH accreditation goals)</td><td>NHM focus on reducing maternal mortality &rarr; nurse designs study on active management of third stage of labour in PHC settings</td></tr>
      <tr><td>6</td><td><strong>Peer Discussions and Expert Consultations</strong></td><td>Discussions with experienced colleagues, mentors, supervisors, and interdisciplinary teams reveal shared clinical concerns</td><td>Nursing faculty at AIIMS discusses high fall rates in orthopaedic wards &rarr; fall prevention study proposed</td></tr>
      <tr><td>7</td><td><strong>Personal Experience and Curiosity</strong></td><td>A nurse's own clinical experience, interest, and observations can spark original research ideas</td><td>Nurse who personally used music during stressful procedures wonders if it helps patients &rarr; designs a formal study</td></tr>
      <tr><td>8</td><td><strong>Social and Community Health Issues</strong></td><td>Community health problems, public health data, and patient feedback reveal areas needing research</td><td>High rate of teenage pregnancy in a district &rarr; study on reproductive health knowledge among adolescent girls in rural Maharashtra</td></tr>
    </tbody>
  </table></div>
</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Mnemonic &mdash; <strong>"CLNP GPS"</strong></div>
  <div class="mnemonic-word"><span>C</span>-<span>L</span>-<span>N</span>-<span>P</span>-<span>G</span>-<span>P</span>-<span>S</span></div>
  <div class="mnemonic-explain"><strong>C</strong> = Clinical practice &bull; <strong>L</strong> = Literature review &bull; <strong>N</strong> = Nursing theories &bull; <strong>P</strong> = Previous research &bull; <strong>G</strong> = Government priorities &bull; <strong>P</strong> = Peer discussions &bull; <strong>S</strong> = Social/community issues</div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">Clinical practice</span><span class="kw">Literature review</span><span class="kw">Knowledge gap</span><span class="kw">Nursing theory</span><span class="kw">Government priorities</span><span class="kw">NHM</span><span class="kw">RMNCH+A</span><span class="kw">Peer discussion</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>8 sources: Clinical practice, Literature review, Previous research recommendations, Nursing theories, Government priorities, Peer discussions, Personal experience, Social issues</li>
    <li><strong>Most systematic source:</strong> Literature review (ROL) &mdash; it formally identifies the knowledge gap</li>
    <li><strong>Most common source:</strong> Clinical practice &mdash; bedside observation of unsolved problems</li>
    <li>Research papers always end with "further studies are needed on..." &rarr; ready-made research problem</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">NHM</span> National Health Mission &mdash; India's flagship public health programme</li>
  <li><span class="term">RMNCH+A</span> Reproductive, Maternal, Newborn, Child, and Adolescent Health &mdash; NHM sub-programme</li>
  <li><span class="term">PHC</span> Primary Health Centre &mdash; first-level government health facility in rural India</li>
  <li><span class="term">NABH</span> National Accreditation Board for Hospitals &mdash; sets quality standards for Indian hospitals</li>
  <li><span class="term">Knowledge gap</span> &mdash; an area where existing research is absent, insufficient, or contradictory</li>
</ul></div>
...
<div class="in-short"><strong>In Short:</strong> A <strong>hypothesis</strong> is a tentative, declarative, testable statement predicting the expected relationship between two or more variables in a defined population, formulated BEFORE data collection.</div>
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Key Features of a Hypothesis</h3>
  <ol class="answer-points">
    <li><strong>Tentative:</strong> It is a prediction, not a proven fact &mdash; it may be right or wrong</li>
    <li><strong>Declarative:</strong> Written as a statement ("Music therapy reduces anxiety"), NOT as a question</li>
    <li><strong>Testable:</strong> Can be confirmed or refuted by collecting and statistically analyzing real data</li>
    <li><strong>States a relationship:</strong> Between at least two variables (IV and DV)</li>
    <li><strong>Written before data collection:</strong> Prevents bias in data collection and analysis</li>
  </ol>
</div>

<div class="editorial-example"><strong>Example:</strong><br>
H1: "Music therapy (IV) significantly reduces pre-operative anxiety scores (DV) in adult surgical patients."<br>
H0: "There is no significant difference in anxiety scores between music therapy and control groups."<br>
&rarr; If data analysis gives p &lt; 0.05: reject H0, support H1.
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">Tentative</span><span class="kw">Declarative</span><span class="kw">Testable</span><span class="kw">H1</span><span class="kw">H0</span><span class="kw">Variable relationship</span><span class="kw">Kerlinger</span>
</div>
...
<div class="in-short"><strong>In Short:</strong> A good hypothesis must be: <strong>Testable</strong>, written in <strong>Declarative form</strong>, <strong>Clear and concise</strong>, stating a <strong>relationship between variables</strong>, <strong>grounded in theory or prior research</strong>, <strong>Falsifiable</strong>, <strong>Specific</strong> about population and setting, and <strong>Consistent with known facts</strong>. Remember: <strong>TD-CRFSC.</strong></div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Introduction</h3>
  <p class="answer-text">Not all statements qualify as good hypotheses. A poorly written hypothesis will lead to an unfocused study, the wrong statistical tests, and uninterpretable results. A good hypothesis must meet specific criteria that make it scientifically useful, precise, and testable.</p>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Characteristics of a Good Hypothesis (TD-CRFSC)</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    ...
    <tbody>
      ...
      <tr><td>5</td><td><strong>Restricted in Scope (Specific)</strong></td><td>Focused and specific; narrow enough to be tested in one study; clearly defines population and setting</td><td>Too broad: "Nursing interventions improve patient outcomes." Specific: "Music therapy reduces HAM-A anxiety in pre-op adults, Nagpur, 2024."</td></tr>
      <tr><td>6</td><td><strong>Falsifiable</strong></td><td>Can potentially be proven WRONG by data; non-falsifiable statements are not scientific hypotheses</td><td>Falsifiable: "KMC increases neonatal temperature" &mdash; data could show no difference, proving it wrong</td></tr>
      <tr><td>7</td><td><strong>Consistent with Known Facts and Existing Theory</strong></td><td>Grounded in prior research or nursing theory; not contradictory to established knowledge without sound reason</td><td>Grounded in evidence: KMC hypothesis is consistent with WHO recommendations and Cochrane reviews</td></tr>
      <tr><td>8</td><td><strong>Written Before Data Collection</strong></td><td>Must be stated before data is collected to prevent researcher bias and ensure objectivity</td><td>Writing hypothesis AFTER seeing data = outcome bias = invalidates the entire study</td></tr>
    </tbody>
  </table></div>
</div>

<div class="analogy-box"><strong>Think of it like&hellip;</strong> a good weather forecast. A forecast must be specific ("Rain tomorrow in Nagpur, 40mm"), testable (we can check if it rained), falsifiable (it might not rain), grounded in meteorological data (existing facts), and stated before the event (not after it's already rained). A hypothesis is a scientific forecast for research.</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Mnemonic &mdash; <strong>"TD-CRFSC"</strong></div>
  <div class="mnemonic-word"><span>T</span>-<span>D</span>-<span>C</span>-<span>R</span>-<span>F</span>-<span>S</span>-<span>C</span></div>
  <div class="mnemonic-explain"><strong>T</strong> = Testable &bull; <strong>D</strong> = Declarative &bull; <strong>C</strong> = Clear &bull; <strong>R</strong> = Relationship stated &bull; <strong>F</strong> = Falsifiable &bull; <strong>S</strong> = Specific/Restricted &bull; <strong>C</strong> = Consistent with known facts</div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">Testable</span><span class="kw">Declarative</span><span class="kw">Falsifiable</span><span class="kw">Clear</span><span class="kw">Specific</span><span class="kw">Variable relationship</span><span class="kw">Theory-grounded</span><span class="kw">TD-CRFSC</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>8 characteristics: TD-CRFSC (Testable, Declarative, Clear, Relationship stated, Falsifiable, Specific, Consistent)</li>
    <li>MOST critical: Testable &mdash; if it can't be tested with data, it's not a hypothesis</li>
    <li>MOST common mistake: writing as a question instead of a declarative statement</li>
    <li>Falsifiable = can potentially be proven WRONG by data (key feature of science)</li>
    <li>Must be written BEFORE data collection to prevent researcher bias</li>
  </ul>
</div>
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Differences Between Assumption and Hypothesis</h3>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Feature</th><th>Assumption</th><th>Hypothesis</th></tr></thead>
    <tbody>
      <tr><td><strong>Definition</strong></td><td>Condition accepted as true without testing or proof</td><td>Testable prediction about relationship between variables</td></tr>
      <tr><td><strong>Is it tested?</strong></td><td>NO &mdash; taken for granted; never formally tested</td><td>YES &mdash; formally tested with statistical analysis of collected data</td></tr>
      <tr><td><strong>Nature</strong></td><td>A belief or foundational premise; always accepted as true in the context of the study</td><td>A tentative prediction that may be confirmed (supported) or rejected based on data</td></tr>
      <tr><td><strong>Outcome</strong></td><td>Remains unchanged; it is not rejected or accepted based on results</td><td>Accepted (H1 supported, p &lt; 0.05) or rejected (H0 retained, p &gt; 0.05) based on statistical results</td></tr>
      <tr><td><strong>Type of statement</strong></td><td>A foundational premise that underlies the study logic</td><td>A predictive statement about what data will show</td></tr>
      <tr><td><strong>Where stated in thesis</strong></td><td>Chapter 1 &mdash; Assumptions section</td><td>Chapter 1 &mdash; Hypotheses section; tested in Chapter 4</td></tr>
      <tr><td><strong>Statistical analysis</strong></td><td>Not required; no p-value computed for assumptions</td><td>Required; p-value computed (p &lt; 0.05 = reject H0)</td></tr>
      <tr><td><strong>Source / Basis</strong></td><td>Self-evident truths, logical necessities, or methodological requirements</td><td>Derived from review of literature, nursing theories, or clinical observations</td></tr>
      <tr><td><strong>Number in a study</strong></td><td>Usually multiple (3&ndash;8 commonly stated)</td><td>One per objective (each objective generates one H1 and one H0)</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Examples from the Same Nursing Study</h3>
  <p class="answer-text"><strong>Study:</strong> "Effect of music therapy on pre-operative anxiety in adult surgical patients, Nagpur."</p>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Assumptions (not tested)</th><th>Hypotheses (tested with data)</th></tr></thead>
    <tbody>
      <tr><td>"Participants will respond to the HAM-A questionnaire honestly."</td><td>H1: "Music therapy significantly reduces HAM-A anxiety scores in the experimental group."</td></tr>
      <tr><td>"The HAM-A scale is a valid and reliable measure of anxiety in Indian patients."</td><td>H0: "There is no significant difference in HAM-A anxiety scores between music therapy and control groups."</td></tr>
      <tr><td>"All participants are capable of hearing the music therapy recording."</td><td>&mdash;</td></tr>
      <tr><td>"The ward environment will remain similar for both groups during the study."</td><td>&mdash;</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title accent-title">Similarities Between Assumption and Hypothesis</h3>
  <ol class="answer-points">
    <li>Both are stated in <strong>Chapter 1</strong> of the research report/thesis</li>
    <li>Both are stated <strong>before data collection begins</strong></li>
    <li>Both involve beliefs about the study; both are based on logical reasoning</li>
    <li>Both influence the design and conduct of the study</li>
  </ol>
</div>

<div class="dont-confuse"><strong>Key Difference in One Sentence:</strong><br>
<strong>Assumption</strong> = "I believe this is true and I'm NOT going to test it."<br>
<strong>Hypothesis</strong> = "I predict this is true AND I WILL test it with data."
</div>

<div class="mnemonic-box">
  <div class="mnemonic-label">Quick Memory Aid</div>
  <div class="mnemonic-explain">
    <strong>Assumption</strong> = <strong>A</strong>ccepted without testing (<strong>A</strong> = not tested)<br>
    <strong>Hypothesis</strong> = <strong>H</strong>as to be tested (<strong>H</strong> = must be tested with statistics)
  </div>
</div>

<div class="keyword-box"><strong>Keywords:</strong>
  <span class="kw">Assumption</span><span class="kw">Hypothesis</span><span class="kw">Not tested</span><span class="kw">Formally tested</span><span class="kw">H1</span><span class="kw">H0</span><span class="kw">p-value</span><span class="kw">Chapter 1</span><span class="kw">Foundation</span><span class="kw">Prediction</span>
</div>

<div class="remember-box">
  <div class="remember-title">Quick Revision</div>
  <ul>
    <li>Assumption = taken for granted, NOT tested | Hypothesis = prediction, IS tested statistically</li>
    <li>Assumption never changes after results; Hypothesis is accepted or rejected based on p-value</li>
    <li>Both stated in Chapter 1; hypothesis also tested in Chapter 4</li>
    <li>Assumption: "Participants answer honestly." Hypothesis: "Music therapy reduces anxiety (p &lt; 0.05)."</li>
    <li>Key similarity: both stated before data collection; both influence study design</li>
  </ul>
</div>

<div class="glossary"><div class="glossary-title">Full Forms &amp; Meanings</div>
<ul>
  <li><span class="term">H1</span> Research Hypothesis &mdash; predicts a significant effect exists; supported if p &lt; 0.05</li>
  <li><span class="term">H0</span> Null Hypothesis &mdash; predicts no significant effect; rejected if p &lt; 0.05</li>
  <li><span class="term">p-value</span> &mdash; probability that result occurred by chance; p &lt; 0.05 = statistically significant</li>
  <li><span class="term">HAM-A</span> Hamilton Anxiety Rating Scale &mdash; validated 14-item anxiety measurement tool</li>
  <li><span class="term">Kerlinger</span> &mdash; research methodologist who defined both assumptions and hypotheses in behavioural research</li>
</ul></div>

<div class="self-test"><div class="self-test-title">Test Yourself</div>
<details><summary>What is the single most important difference between assumption and hypothesis?</summary><p>An assumption is NEVER formally tested &mdash; it is accepted as true without proof. A hypothesis IS formally tested with statistical analysis of collected data, and is either supported (p &lt; 0.05) or rejected (p &gt; 0.05) based on the results.</p></details>
...
<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title">Definition of Variable</h3>
  <div class="definition-box animate-scale-in">
    A <strong>variable</strong> is any <strong>characteristic, attribute, quality, or condition that can take different values</strong> (varies) among subjects, settings, or situations in a research study.<br><br>
    <strong>Kerlinger:</strong> "A variable is a symbol to which numerals or values are assigned."<br><br>
    <strong>Simple words:</strong> "Anything that changes or differs from person to person, situation to situation, or over time is a variable."<br><br>
    <strong>Examples:</strong> Blood pressure, pain score, age, gender, anxiety level, neonatal weight, nurse-patient ratio, number of medication errors.
  </div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Types of Variables with Examples</h3>

  <h4>1. Based on Role in Research</h4>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Type</th><th>Simple Meaning</th><th>Nursing Example</th></tr></thead>
    <tbody>
  ...
  <h4>2. Based on Measurement Scale</h4>
  <div class="answer-table-wrap"><table class="answer-table">
    <thead><tr><th>Type</th><th>Simple Meaning</th><th>Nursing Example</th></tr></thead>
    <tbody>
      <tr><td><strong>Continuous Variable</strong></td><td>Can take ANY value within a range, including decimals; measured on a scale</td><td>Weight (54.3 kg), temperature (37.2&deg;C), blood pressure (118/76 mmHg), pain score (7.5/10)</td></tr>
      <tr><td><strong>Discrete Variable</strong></td><td>Can only take WHOLE NUMBER values; counted (not measured); no fractions possible</td><td>Number of pressure ulcers (0, 1, 2...), number of deliveries, medication errors per shift</td></tr>
      <tr><td><strong>Qualitative / Categorical Variable</strong></td><td>Describes categories or groups; no numerical value; analyzed by frequency and percentage</td><td>Gender (M/F), blood group (A/B/AB/O), type of surgery, religion, marital status</td></tr>
      <tr><td><strong>Quantitative Variable</strong></td><td>Has a numerical value; can be statistically analyzed (mean, SD, t-test)</td><td>Haemoglobin level, birth weight, HAM-A score, Braden Scale score, NRS pain score</td></tr>
    </tbody>
  </table></div>
</div>

<div class="answer-section animate-slide-up">
  <h3 class="answer-section-title teal-title">Identifying Variables in a Nursing Study</h3>
  <p class="answer-text"><strong>Study:</strong> "Effect of music therapy on pre-operative anxiety in adult surgical patients, Nagpur, 2024."</p>
  <ul class="answer-points">
...
<div class="mnemonic-box">
  <div class="mnemonic-label">Memory Aid for Variable Types</div>
  <div class="mnemonic-explain">
