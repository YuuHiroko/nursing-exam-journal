...
<div class="answer-section animate-slide-up">
  ...
  <div class="keyword-box"><strong>Keywords examiner wants:</strong>
    <span class="kw">42 days</span><span class="kw">MMR / 1,00,000 live births</span><span class="kw">Direct vs Indirect</span><span class="kw">Atonic uterus</span><span class="kw">PPH</span><span class="kw">Eclampsia</span><span class="kw">Oxytocin</span><span class="kw">MgSO4</span><span class="kw">JSY</span><span class="kw">SBA</span><span class="kw">EmOC</span>
  </div>

  <div class="dont-confuse"><strong>Don't Confuse:</strong>
    <br><strong>Mortality vs Morbidity:</strong> Mortality = death. Morbidity = sickness (woman is alive but suffering).
    <br><strong>MMRatio vs MMRate:</strong> MM<u>R</u>atio uses live <u>B</u>irths in the denominator. MM<u>Rate</u> uses women of reproductive <u>age</u> (15&ndash;49 yrs).
    <br><strong>Direct vs Indirect:</strong> Direct = pregnancy ITSELF caused it (PPH, eclampsia). Indirect = an old disease made worse by pregnancy (anaemia, heart disease).
  </div>
</div>
...
<div class="exam-strategy"><strong>How to Write This in Exam (15 marks):</strong>
  <br>&bull; Definition + MMR formula &mdash; <strong>2 marks</strong> (~3 min)
  <br>&bull; Causes (Direct + Indirect table) &mdash; <strong>5 marks</strong> (~8 min) &rarr; draw the classification flowchart, examiners love diagrams
  <br>&bull; Strategies to reduce MMR &mdash; <strong>5 marks</strong> (~8 min)
  <br>&bull; Role of nurse midwife &mdash; <strong>3 marks</strong> (~5 min)
...
<div class="glossary">
  ...
  <ul>
    <li><span class="term">MMR</span> Maternal Mortality Ratio &mdash; deaths per 1,00,000 live births</li>
    <li><span class="term">PPH</span> Post-Partum Haemorrhage &mdash; heavy bleeding after delivery</li>
    <li><span class="term">APH</span> Ante-Partum Haemorrhage &mdash; bleeding before delivery</li>
    <li><span class="term">SBA</span> Skilled Birth Attendant &mdash; trained nurse/doctor present at delivery</li>
    <li><span class="term">EmOC</span> Emergency Obstetric Care &mdash; hospital care for delivery emergencies</li>
    <li><span class="term">JSY</span> Janani Suraksha Yojana &mdash; cash scheme that encourages hospital delivery</li>
    <li><span class="term">MgSO4</span> Magnesium Sulphate &mdash; injection to stop/prevent eclampsia fits</li>
    <li><span class="term">MDR</span> Maternal Death Review &mdash; studying each death to prevent the next one</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>Within how many days after delivery does a death still count as "maternal"?</summary><p>42 days after the end of pregnancy.</p></details>
  <details><summary>What is the #1 direct cause of maternal death in India?</summary><p>Haemorrhage (bleeding) &mdash; especially PPH due to an atonic uterus.</p></details>
  <details><summary>Give the mnemonic for direct causes and expand it.</summary><p>HOUSE &mdash; Haemorrhage, Obstructed labour, Unsafe abortion, Sepsis, Eclampsia.</p></details>
  <details><summary>Which injection is used to control eclampsia fits?</summary><p>Magnesium Sulphate (MgSO4) &mdash; e.g. the Pritchard regimen.</p></details>
  <details><summary>State India's current MMR and the SDG 2030 target.</summary><p>Current MMR &asymp; 97 per 1,00,000 live births; SDG target is below 70 by 2030.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">Direct causes</span><span class="kw">Indirect causes</span><span class="kw">Haemorrhage</span><span class="kw">PPH / APH</span><span class="kw">Eclampsia</span><span class="kw">Puerperal Sepsis</span><span class="kw">Unsafe Abortion</span><span class="kw">Obstructed Labour</span><span class="kw">Anaemia</span><span class="kw">MMR 97</span><span class="kw">SDG &lt; 70 by 2030</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>APH vs PPH:</strong> APH = bleeding BEFORE delivery (ante-partum). PPH = bleeding AFTER delivery (post-partum). PPH is the #1 direct killer.
  <br><strong>Pre-eclampsia vs Eclampsia:</strong> Pre-eclampsia = high BP + protein in urine, but NO fits yet. Eclampsia = fits have started. Eclampsia is more life-threatening.
  <br><strong>Direct vs Indirect:</strong> Direct = pregnancy CAUSED the problem. Indirect = old disease (e.g. anaemia) made WORSE by pregnancy.
</div>
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">MMR</span> Maternal Mortality Ratio &mdash; number of maternal deaths per 1,00,000 live births</li>
    <li><span class="term">PPH</span> Post-Partum Haemorrhage &mdash; heavy bleeding after delivery; #1 direct killer</li>
    <li><span class="term">APH</span> Ante-Partum Haemorrhage &mdash; bleeding before delivery (e.g. placenta previa)</li>
    <li><span class="term">SDG</span> Sustainable Development Goal &mdash; global target: MMR below 70 by 2030</li>
    <li><span class="term">HOUSE</span> Mnemonic &mdash; Haemorrhage, Obstructed labour, Unsafe abortion, Sepsis, Eclampsia</li>
    <li><span class="term">IFA</span> Iron and Folic Acid &mdash; daily tablet given during pregnancy to prevent anaemia</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>Name the #1 direct cause and the #1 indirect cause of maternal mortality in India.</summary><p>Direct #1 = Haemorrhage (especially PPH). Indirect #1 = Anaemia.</p></details>
  <details><summary>What does the mnemonic HOUSE stand for?</summary><p>Haemorrhage, Obstructed labour, Unsafe abortion, Sepsis, Eclampsia &mdash; the five main direct causes.</p></details>
  <details><summary>What is the difference between pre-eclampsia and eclampsia?</summary><p>Pre-eclampsia = high BP + protein in urine, but no fits yet. Eclampsia = fits (convulsions) have begun. Eclampsia is the life-threatening stage.</p></details>
  <details><summary>What is India's current MMR and the SDG 2030 target?</summary><p>India's MMR = 97 per 1,00,000 live births (SRS 2018-20). SDG target = below 70 by 2030.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">Maternal mortality</span><span class="kw">Maternal morbidity</span><span class="kw">Near-miss</span><span class="kw">Obstetric fistula (VVF)</span><span class="kw">Uterine prolapse</span><span class="kw">Postnatal depression</span><span class="kw">Anaemia</span><span class="kw">20&ndash;30x more morbidity</span><span class="kw">MMR 97</span><span class="kw">SDG &lt; 70</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>Mortality vs Morbidity:</strong> Mortality = mother DIES. Morbidity = mother is SICK but alive. Morbidity is 20&ndash;30 times more common than mortality.
  <br><strong>Near-miss vs Morbidity:</strong> Near-miss = woman almost died but was saved (a severe event). Morbidity includes ALL degrees of sickness &mdash; from mild anaemia to near-miss events.
...
<div class="glossary">
  ...
  <ul>
    <li><span class="term">MMR</span> Maternal Mortality Ratio &mdash; deaths per 1,00,000 live births</li>
    <li><span class="term">VVF</span> Vesico-Vaginal Fistula &mdash; hole between bladder and vagina; urine leaks constantly</li>
    <li><span class="term">RVF</span> Recto-Vaginal Fistula &mdash; hole between rectum and vagina; stool leaks</li>
    <li><span class="term">Near-miss</span> A woman who almost died from a complication but survived</li>
    <li><span class="term">EmOC</span> Emergency Obstetric Care &mdash; hospital treatment for life-threatening delivery emergencies</li>
    <li><span class="term">MDR</span> Maternal Death Review &mdash; investigating every maternal death to prevent the next one</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>What is the difference between maternal mortality and maternal morbidity?</summary><p>Mortality = mother dies from a pregnancy-related cause. Morbidity = mother survives but suffers serious illness (e.g. fistula, anaemia, depression).</p></details>
  <details><summary>For every 1 maternal death, how many women suffer serious morbidity?</summary><p>20&ndash;30 women suffer serious illness (morbidity) for every 1 maternal death.</p></details>
  <details><summary>What is an obstetric fistula and how does it happen?</summary><p>A fistula is an abnormal hole &mdash; VVF between bladder and vagina (urine leaks) or RVF between rectum and vagina (stool leaks). It is caused by prolonged obstructed labour where the baby's head presses on soft tissues and cuts off blood supply, causing tissue death.</p></details>
  <details><summary>What is a "near-miss" case and why is it important to track?</summary><p>A near-miss is a woman who almost died from a severe complication but survived. Tracking near-misses reveals gaps in emergency care that can be fixed before the next woman dies.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">ANC</span><span class="kw">AMTSL</span><span class="kw">Partograph</span><span class="kw">ASHA &amp; VHND</span><span class="kw">High-risk referral</span><span class="kw">MgSO4 for eclampsia</span><span class="kw">Oxytocin for PPH</span><span class="kw">JSY / JSSK</span><span class="kw">MCP card</span><span class="kw">MDR</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>AMTSL vs partograph:</strong> AMTSL (Active Management of Third Stage of Labour) = giving oxytocin after delivery to prevent PPH. Partograph = a chart used to MONITOR labour progress (cervix opening, baby's heartbeat, contractions). They serve different purposes.
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">AMTSL</span> Active Management of Third Stage of Labour &mdash; oxytocin injection + cord traction + uterine massage to prevent PPH</li>
    <li><span class="term">PPH</span> Post-Partum Haemorrhage &mdash; heavy bleeding after delivery; #1 direct cause of maternal death</li>
    <li><span class="term">MgSO4</span> Magnesium Sulphate &mdash; injection given to stop or prevent eclampsia fits</li>
    <li><span class="term">SBA</span> Skilled Birth Attendant &mdash; trained nurse/ANM/doctor present at every delivery</li>
    <li><span class="term">MDR</span> Maternal Death Review &mdash; review of every maternal death to learn and prevent future deaths</li>
    <li><span class="term">MCP card</span> Mother and Child Protection card &mdash; health record kept by the mother throughout pregnancy</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>What does AMTSL stand for and why is it important?</summary><p>Active Management of Third Stage of Labour. It involves giving oxytocin within 1 minute of delivery + controlled cord traction + uterine massage. It prevents PPH &mdash; the #1 direct killer of mothers.</p></details>
  <details><summary>Name three danger signs a nurse must teach a pregnant woman to watch for at home.</summary><p>Any three from: heavy bleeding, severe headache, fits/convulsions, high fever, no baby movement, blurred vision, swelling of face/hands.</p></details>
  <details><summary>What injection does the nurse give for eclampsia and for PPH?</summary><p>Eclampsia = MgSO4 (Magnesium Sulphate). PPH = Oxytocin (IV). Both require immediate referral.</p></details>
  <details><summary>On which days does the nurse do postnatal home visits?</summary><p>Day 3, Day 7, and Day 42 after delivery.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">ICM definition</span><span class="kw">ANC / Intranatal / PNC</span><span class="kw">Partograph</span><span class="kw">AMTSL</span><span class="kw">Respectful Maternity Care</span><span class="kw">Skin-to-skin</span><span class="kw">Exclusive breastfeeding 6 months</span><span class="kw">JSY / JSSK / PMSMA</span><span class="kw">Evidence-based practice</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>Midwife vs Dai:</strong> Midwife = formally trained nurse (ANM/Staff Nurse) who can safely conduct deliveries and manage complications. Dai = traditional birth attendant, NOT formally trained, potentially unsafe. India is replacing dais with trained SBAs.
  <br><strong>AMTSL vs AMTSL components:</strong> AMTSL = (1) Oxytocin within 1 min, (2) Controlled cord traction, (3) Uterine massage. All three together. Missing any one reduces its effectiveness.
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">ICM</span> International Confederation of Midwives &mdash; gives the global definition of a midwife</li>
    <li><span class="term">AMTSL</span> Active Management of Third Stage of Labour &mdash; oxytocin + cord traction + massage to prevent PPH</li>
    <li><span class="term">RMC</span> Respectful Maternity Care &mdash; treating every mother with dignity, no scolding or abuse</li>
    <li><span class="term">PMSMA</span> Pradhan Mantri Surakshit Matritva Abhiyan &mdash; free specialist ANC checkup on the 9th of every month</li>
    <li><span class="term">VHND</span> Village Health and Nutrition Day &mdash; monthly ANC + immunization + nutrition services at village level</li>
    <li><span class="term">INC</span> Indian Nursing Council &mdash; the body that sets standards and grants nursing licenses in India</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>What is the ICM definition of a nurse midwife?</summary><p>A trained person who can independently care for pregnant women, conduct normal deliveries, care for newborns, and identify complications that need a doctor's help.</p></details>
  <details><summary>Name the 5 roles of a nurse in midwifery using the AIPCA mnemonic.</summary><p>A = Antenatal Care, I = Intranatal Care, P = Postnatal Care, C = Community Health Role, A = Administrative &amp; Research Role.</p></details>
  <details><summary>What is a partograph and when is it used?</summary><p>A partograph is a chart used during labour to monitor: cervix dilation, baby's heartbeat, contractions, and mother's vital signs. It helps detect slow or abnormal labour early so timely action can be taken.</p></details>
  <details><summary>What is Respectful Maternity Care (RMC)?</summary><p>RMC means treating every mother with dignity and respect during delivery &mdash; no scolding, no abuse, maintaining privacy, obtaining consent before every procedure, and letting her have a support person.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">MTP Act 1971/2021</span><span class="kw">PCPNDT Act 1994</span><span class="kw">NRHM 2005</span><span class="kw">JSY</span><span class="kw">JSSK</span><span class="kw">Maternity Benefit Act</span><span class="kw">POCSO 2012</span><span class="kw">Surrogacy Act 2021</span><span class="kw">RCH Programme</span><span class="kw">SDG 3.1</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>MTP Act vs PCPNDT Act:</strong> MTP = about ENDING a pregnancy safely (legal abortion). PCPNDT = about NOT knowing the baby's sex (ban on sex determination). Very different purposes.
  <br><strong>JSY vs JSSK:</strong> JSY = cash given TO the mother for delivering in hospital. JSSK = services given FOR FREE (delivery, medicines, blood, ambulance, food) &mdash; no cash, but zero expense.
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">MTP Act</span> Medical Termination of Pregnancy Act (1971, amended 2021) &mdash; makes safe abortion legal in India</li>
    <li><span class="term">PCPNDT Act</span> Pre-Conception &amp; Pre-Natal Diagnostic Techniques Act (1994) &mdash; bans sex determination of the fetus</li>
    <li><span class="term">JSSK</span> Janani Shishu Suraksha Karyakram &mdash; free delivery, medicines, blood, food, and ambulance for mothers and babies</li>
    <li><span class="term">POCSO</span> Protection of Children from Sexual Offences Act (2012) &mdash; mandates reporting of child sexual abuse</li>
    <li><span class="term">RCH</span> Reproductive and Child Health Programme &mdash; umbrella programme for maternal, child, and adolescent health</li>
    <li><span class="term">SDG 3.1</span> Sustainable Development Goal 3.1 &mdash; reduce global MMR below 70 per 1,00,000 live births by 2030</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>Up to what gestational age can an abortion be performed with just 1 doctor's opinion under the MTP Act?</summary><p>Up to 20 weeks of pregnancy. Between 20 and 24 weeks, 2 doctors are required (for special cases like rape, fetal defects, minors). After 24 weeks, only if a Medical Board approves.</p></details>
  <details><summary>What does the PCPNDT Act prohibit, and what is the punishment?</summary><p>It prohibits revealing the sex of the fetus before birth and sex-selective abortion. Punishment: up to 5 years imprisonment and Rs. 1 lakh fine.</p></details>
  <details><summary>What is the key difference between JSY and JSSK?</summary><p>JSY = cash incentive given TO the mother for delivering in a hospital. JSSK = free services provided (delivery, C-section, medicines, food, ambulance) &mdash; zero expense for the family.</p></details>
  <details><summary>Under the Maternity Benefit Act (2017), how many weeks of paid leave does a working mother get for her first child?</summary><p>26 weeks of paid maternity leave for the first two children. Reduced to 12 weeks for the third child.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">NRHM 2005</span><span class="kw">NHM 2013</span><span class="kw">ASHA worker</span><span class="kw">JSY</span><span class="kw">JSSK</span><span class="kw">VHSNC</span><span class="kw">IPHS</span><span class="kw">Rogi Kalyan Samiti</span><span class="kw">108/102 Ambulance</span><span class="kw">MMR 254 &rarr; 97</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>NRHM vs NHM:</strong> NRHM (National Rural Health Mission, 2005) = only rural areas. NHM (National Health Mission, 2013) = NRHM + NUHM (urban areas). NHM is the bigger, updated version.
  <br><strong>ASHA vs ANM:</strong> ASHA = Accredited Social Health Activist, a community volunteer (not a nurse), one per 1000 population. ANM = Auxiliary Nurse Midwife, a formally trained health worker stationed at the Sub-Centre. ASHA motivates; ANM provides clinical care.
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">NRHM</span> National Rural Health Mission &mdash; India's largest rural health programme (2005)</li>
    <li><span class="term">NHM</span> National Health Mission &mdash; NRHM + NUHM combined (2013 onwards)</li>
    <li><span class="term">ASHA</span> Accredited Social Health Activist &mdash; village-level link worker (1 per 1000 people)</li>
    <li><span class="term">VHSNC</span> Village Health, Sanitation &amp; Nutrition Committee &mdash; community body managing local health with Rs. 10,000/year untied fund</li>
    <li><span class="term">IPHS</span> Indian Public Health Standards &mdash; quality standards for Sub-Centres, PHCs, CHCs, and District Hospitals</li>
    <li><span class="term">RKS</span> Rogi Kalyan Samiti (Patient Welfare Committee) &mdash; hospital management committee that uses untied funds for quality improvement</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>When was NRHM launched and which states were given priority?</summary><p>NRHM was launched on 12th April 2005. It focused on 18 high-priority states with weak health indicators, including UP, Bihar, MP, Rajasthan, Jharkhand, and Odisha.</p></details>
  <details><summary>What does ASHA stand for and what is her ratio?</summary><p>Accredited Social Health Activist. One ASHA is deployed per 1000 population in every village. She motivates community members to use health services and accompanies pregnant women to hospitals.</p></details>
  <details><summary>What happened to NRHM in 2013?</summary><p>In 2013, NRHM was expanded into NHM (National Health Mission) by adding NUHM (National Urban Health Mission) to also cover urban slum populations.</p></details>
  <details><summary>Name any two measurable achievements of NRHM.</summary><p>Any two: Hospital deliveries rose from 40.7% to 88.6%. MMR dropped from 254 to 97 per 1,00,000 live births. More than 10 lakh ASHA workers deployed. Free 108/102 ambulances introduced.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">RCH-I (1997)</span><span class="kw">RCH-II (2005)</span><span class="kw">Client-centered approach</span><span class="kw">Safe Motherhood</span><span class="kw">IMNCI</span><span class="kw">Cafeteria approach</span><span class="kw">RKSK</span><span class="kw">Adolescent health</span><span class="kw">RTI/STI</span><span class="kw">PPIUCD</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>RCH vs NRHM:</strong> RCH = the content (what services to give: safe motherhood, child health, family planning, etc.). NRHM = the delivery system (how to deliver those services: ASHAs, JSY, ambulances, etc.). RCH-II was integrated INTO NRHM in 2005.
  <br><strong>CSSM vs RCH:</strong> CSSM (Child Survival and Safe Motherhood) was the programme BEFORE RCH. RCH replaced it in 1997 by adding family planning and RTI/STI management.
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">RCH</span> Reproductive and Child Health Programme &mdash; India's comprehensive maternal and child health programme (Phase I: 1997, Phase II: 2005)</li>
    <li><span class="term">CSSM</span> Child Survival and Safe Motherhood &mdash; the older programme replaced by RCH in 1997</li>
    <li><span class="term">IMNCI</span> Integrated Management of Neonatal and Childhood Illnesses &mdash; standard protocol to assess and treat sick newborns and children</li>
    <li><span class="term">RKSK</span> Rashtriya Kishor Swasthya Karyakram &mdash; national adolescent health programme (nutrition, mental health, reproductive health)</li>
    <li><span class="term">PPIUCD</span> Post-Partum Intra-Uterine Contraceptive Device &mdash; Copper-T inserted within 48 hours of delivery for spacing</li>
    <li><span class="term">RTI / STI</span> Reproductive Tract Infection / Sexually Transmitted Infection &mdash; infections affecting reproductive organs</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>What are the 5 components of the RCH Programme? Use the SCARF mnemonic.</summary><p>S = Safe Motherhood, C = Child Health, A = Adolescent Health (RKSK), R = RTI/STI Management, F = Family Planning. Together = SCARF (or SCFAR if you prefer the flowchart order).</p></details>
  <details><summary>What was the key change RCH made to family planning compared to the old approach?</summary><p>RCH shifted from a "target-based" approach (forced sterilization quotas) to a "client-centered, cafeteria approach" where couples freely choose from all available contraceptive options.</p></details>
  <details><summary>What is RKSK and what does it cover?</summary><p>RKSK = Rashtriya Kishor Swasthya Karyakram. It covers adolescent health: nutrition, mental health, sexual/reproductive health, substance abuse prevention, menstrual hygiene, and violence prevention. WIFS (weekly iron-folic acid) for school children is part of it.</p></details>
  <details><summary>Name two spacing methods and two limiting methods under RCH family planning.</summary><p>Spacing: IUCD/Copper-T, OCP (oral pills), condoms, injectable (Antara/DMPA). Limiting: Tubectomy (female sterilization), Vasectomy (male sterilization).</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">Safe Motherhood Initiative 1987</span><span class="kw">4 Pillars FACE</span><span class="kw">Family Planning</span><span class="kw">ANC minimum 4 visits</span><span class="kw">SBA</span><span class="kw">5 Cleans</span><span class="kw">BEmOC / CEmOC</span><span class="kw">JSY / JSSK</span><span class="kw">LaQshya</span><span class="kw">PMSMA</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>BEmOC vs CEmOC:</strong> BEmOC (Basic Emergency Obstetric Care) = antibiotics, oxytocin, MgSO4, manual placenta removal, assisted delivery. CEmOC = BEmOC PLUS C-section and blood transfusion. Both must be available 24/7.
  <br><strong>SMI vs Safe Motherhood schemes:</strong> SMI (Safe Motherhood Initiative, 1987, Nairobi) = the global movement/concept. JSY, JSSK, PMSMA, LaQshya = India's government SCHEMES that implement Safe Motherhood.
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">SMI</span> Safe Motherhood Initiative &mdash; global movement launched in 1987 in Nairobi to reduce maternal mortality</li>
    <li><span class="term">BEmOC</span> Basic Emergency Obstetric Care &mdash; antibiotics, oxytocin, MgSO4, manual placenta removal, assisted delivery</li>
    <li><span class="term">CEmOC</span> Comprehensive EmOC &mdash; BEmOC plus C-section and blood transfusion; available at district hospitals</li>
    <li><span class="term">SBA</span> Skilled Birth Attendant &mdash; trained nurse/ANM/doctor who conducts delivery safely</li>
    <li><span class="term">LaQshya</span> Labour Room Quality Improvement Initiative &mdash; ensures clean, respectful, well-equipped labour rooms</li>
    <li><span class="term">PMSMA</span> Pradhan Mantri Surakshit Matritva Abhiyan &mdash; free specialist ANC checkup on the 9th of every month</li>
  </ul>
</div>
...
<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>When and where was the Safe Motherhood Initiative launched?</summary><p>1987 in Nairobi, Kenya at an international conference organized by WHO, UNICEF, UNFPA, and the World Bank.</p></details>
  <details><summary>What are the 4 pillars of Safe Motherhood? Give the mnemonic.</summary><p>FACE: Family planning, Antenatal care, Clean &amp; safe delivery, Emergency obstetric care.</p></details>
  <details><summary>What are the "5 Cleans" in safe delivery?</summary><p>Clean hands, clean delivery surface, clean cord cutting, clean cord tie, and clean wrapping of the baby. These prevent infection during delivery.</p></details>
  <details><summary>What is the difference between BEmOC and CEmOC?</summary><p>BEmOC = antibiotics, oxytocin, MgSO4, manual placenta removal, assisted delivery (forceps/vacuum). CEmOC = all of BEmOC PLUS Caesarean section and blood transfusion. Both must be available 24 hours, 7 days a week.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">Legal vs Ethical</span><span class="kw">MTP Act</span><span class="kw">PCPNDT Act</span><span class="kw">Informed Consent</span><span class="kw">Autonomy</span><span class="kw">Beneficence</span><span class="kw">Non-maleficence</span><span class="kw">Justice</span><span class="kw">Confidentiality</span><span class="kw">POCSO mandatory reporting</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>Legal vs Ethical:</strong> Legal = written in law; breaking it means jail, fine, or license cancelled. Ethical = based on moral principles; breaking it leads to action by the professional body (INC). Note: something can be legal but unethical (e.g. withholding empathy).
  <br><strong>Autonomy vs Non-maleficence conflict:</strong> Autonomy = patient's right to decide, even against medical advice. Non-maleficence = duty to avoid harm. When a patient refuses a C-section that could save the baby, both principles clash &mdash; counsel fully, then respect the decision.
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">MTP Act</span> Medical Termination of Pregnancy Act (1971/2021) &mdash; legal framework for safe abortion in India</li>
    <li><span class="term">PCPNDT</span> Pre-Conception &amp; Pre-Natal Diagnostic Techniques Act (1994) &mdash; bans sex determination; fine Rs. 1 lakh + 5 years jail</li>
    <li><span class="term">POCSO</span> Protection of Children from Sexual Offences Act (2012) &mdash; mandatory reporting of child sexual abuse to police</li>
    <li><span class="term">INC</span> Indian Nursing Council &mdash; professional body that enforces ethical standards and can cancel a nurse's license</li>
    <li><span class="term">Autonomy</span> Patient's right to make decisions about their own body and treatment</li>
    <li><span class="term">Non-maleficence</span> Ethical principle: "First, do no harm" &mdash; avoid unnecessary procedures</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>What is the difference between a legal issue and an ethical issue in nursing?</summary><p>Legal = governed by Acts (MTP, PCPNDT, POCSO); breaking them = criminal punishment. Ethical = governed by moral principles (autonomy, justice, confidentiality); breaking them = professional disciplinary action by the INC.</p></details>
  <details><summary>Name the 4 ethical principles with one-line definitions.</summary><p>Autonomy = patient's right to choose. Beneficence = do good. Non-maleficence = do no harm. Justice = treat all patients equally and fairly.</p></details>
  <details><summary>Under what circumstances does a nurse MUST mandatorily report a case to police?</summary><p>If a minor (under 18) is pregnant due to sexual abuse &mdash; this is a POCSO Act case. Mandatory police reporting is required by law. HIV status does NOT require police reporting.</p></details>
  <details><summary>Can an unmarried woman get a legal abortion in India? Under which law?</summary><p>Yes. The 2021 amendment to the MTP Act specifically extended the right to safe abortion to unmarried women up to 24 weeks (for eligible cases), removing the earlier married-only restriction.</p></details>
</div>
`
  },
...
<div class="keyword-box"><strong>Keywords examiner wants:</strong>
  <span class="kw">Non-judgmental care</span><span class="kw">Confidentiality</span><span class="kw">Social stigma</span><span class="kw">Unsafe abortion risk</span><span class="kw">Options counseling</span><span class="kw">MTP Act 2021 (unmarried women included)</span><span class="kw">CARA (adoption)</span><span class="kw">Swadhar Greh</span><span class="kw">Women Helpline 181</span><span class="kw">POCSO reporting</span>
</div>

<div class="dont-confuse"><strong>Don't Confuse:</strong>
  <br><strong>Options counseling vs directive counseling:</strong> Options counseling = nurse presents all choices (keep baby, adoption, MTP) neutrally, letting the woman decide. Directive counseling = telling her what to do. The nurse must do OPTIONS counseling, not directive.
  <br><strong>Altruistic vs commercial surrogacy:</strong> Altruistic surrogacy (allowed) = a close relative carries the baby out of love, no money. Commercial surrogacy (BANNED since 2021) = paying someone to carry the baby. An unmarried mother's baby CANNOT be placed with a commercial surrogate.
  <br><strong>CARA vs Swadhar Greh:</strong> CARA = Central Adoption Resource Authority (handles baby adoption process). Swadhar Greh = government shelter home where the mother herself can live safely during and after pregnancy.
</div>
...
<div class="glossary">
  <div class="glossary-title">Full Forms &amp; Easy Meanings</div>
  <ul>
    <li><span class="term">CARA</span> Central Adoption Resource Authority &mdash; government body that manages the baby adoption process in India</li>
    <li><span class="term">Swadhar Greh</span> Government shelter home for women in distress &mdash; provides safe housing, food, counseling, and vocational training</li>
    <li><span class="term">POCSO</span> Protection of Children from Sexual Offences Act (2012) &mdash; mandatory police reporting if a minor is pregnant due to abuse</li>
    <li><span class="term">MTP Act 2021</span> Medical Termination of Pregnancy Act Amendment &mdash; specifically includes unmarried women's right to safe abortion up to 24 weeks</li>
    <li><span class="term">181</span> Women's Helpline number &mdash; free, 24x7, for women facing domestic violence, abuse, or crisis</li>
    <li><span class="term">Options counseling</span> Non-directive counseling where all choices (keep baby, adopt, MTP) are presented neutrally for the woman to decide</li>
  </ul>
</div>

<div class="self-test">
  <div class="self-test-title">Test Yourself (cover the answers first!)</div>
  <details><summary>Name the 5 categories of problems faced by an unmarried mother. Use the SEHFL mnemonic.</summary><p>S = Social stigma (isolation, family rejection), E = Emotional problems (depression, anxiety, suicide risk), H = Health risks (hidden pregnancy, no ANC, unsafe abortion risk), F = Financial crisis (no income, no support), L = Legal issues (custody, POCSO if minor).</p></details>
  <details><summary>What is the MOST IMPORTANT principle in caring for an unmarried mother?</summary><p>Non-judgmental care. The nurse must accept her as she is, without moral lectures, rude comments, or gossiping. Her confidentiality must be strictly maintained.</p></details>
  <details><summary>Can an unmarried woman get a safe abortion in India? Where should the nurse direct her?</summary><p>Yes. The MTP Act (2021 amendment) includes unmarried women. The nurse should refer her to an approved MTP centre with a registered doctor. Up to 20 weeks, 1 doctor suffices; 20&ndash;24 weeks requires 2 doctors.</p></details>
  <details><summary>If a 16-year-old girl comes pregnant due to rape, what must the nurse do legally?</summary><p>This is a POCSO Act case. The nurse is legally required to make a mandatory police report. She should also connect the girl with legal aid and counseling, and arrange safe abortion if she chooses.</p></details>
</div>
`
  }
];
